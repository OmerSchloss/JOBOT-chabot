...
def load_indeed_jobs_div(job_title, location, job_type):
    getVars = {'q': job_title, 'l': location, 'sc': job_type,
    ...
    for job_title in job_titles:
        for job_location in job_locations:
            new_jobs_list, num_listings = find_jobs_from(
                'Indeed', job_title, job_location, job_type, desired_characs)
...
if __name__ == "__main__":
    ...
    jobs_list = find_jobs_from(
        'Indeed', 'data scientist', 'alabama', 'fulltime', desired_characs)
