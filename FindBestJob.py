...
if __name__ == '__main__':
    ...
    for index, row in df_QA.iterrows():
        ...
        print("\nBest Job Option:")
        print("Job Name:", best_job['Job name'])
        print("Company:", best_job['Job Company'])
        print("Location:", best_job['Job location'])
        print("Description:", best_job['Job description'])